...
pool.common = [ 
    ...
    if(price == 100)
    {
        if(key<=1) response.key = prize.legendary[prize.legendary.length * Math.random() | 0]
        else if(key<=10) response.key = prize.rare[prize.rare.length * Math.random() | 0]
        else response.key = prize.common[prize.common.length * Math.random() | 0]
    }
    else if(price == 500)
    {
        if(key<=5) response.key = prize.legendary[prize.legendary.length * Math.random() | 0]
        else if(key<=20) response.key = prize.rare[prize.rare.length * Math.random() | 0]
        else response.key = prize.common[prize.common.length * Math.random() | 0]
    }
    else if(price == 5000)
    {
        if(key<=10) response.key = prize.legendary[prize.legendary.length * Math.random() | 0]
        else response.key = prize.rare[prize.rare.length * Math.random() | 0]
    }
